upload_content = [
  ...
  { content = "Gina Rocks, everyone! (created via our dynamic block)", file = "/terraform/test3.txt", executable = true },
  { content = "This class is awesome! (created via our dynamic block)", file = "/terraform/test4.txt", executable = true },
